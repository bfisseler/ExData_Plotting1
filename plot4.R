...
plot(dfHPC$DateTime, dfHPC$Voltage, type = "s", xlab = "datetime", ylab = "Voltage")
...
plot(dfHPC$DateTime, dfHPC$Global_reactive_power, type = "s", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()
